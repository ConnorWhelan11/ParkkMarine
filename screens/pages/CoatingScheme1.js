...
export default class CoatingScheme1 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      tableData: props.dryDockStore.offlineReportData.slides[index].scheme,
      displayTable: props.dryDockStore.offlineReportData.slides[index].displayTable,
      index,
    }
  }
  ...
  _pickerItems(){
    return this.props.dryDockStore.offlineReportData.slides[this.state.index].colors.map((row, index) => {
      return {
        key: row.name,
        text: row.name,
        value: row.code,
  ...
  componentWillUnmount(){
    this.props.dryDockStore.offlineReportData.slides[this.state.index].scheme = this.state.tableData;
    this.props.dryDockStore.offlineReportData.slides[this.state.index].displayTable = this.state.displayTable;
