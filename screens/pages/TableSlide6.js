...
@observer
export default class TableSlide6 extends Component {

  constructor(props){
    super(props);

    this.state = {
      tableData: props.dryDockStore.offlineReportData.slides[5],
      displayTable: props.dryDockStore.offlineReportData.slides[5].displayTable,
    }
  }
    ...
    const items = [
      {
        key: 'no',
        color: 'black',
        text: 'No or Light Biofilm',
        value: 'no',
      },
      {
        key: 'light',
        color: '#C2D69A',
        text: 'Light or Moderate Biofilm',
        value: 'light',
      },
      {
        key: 'moderate',
        color: '#75923C',
        text: 'Moderate Biofilm and/or Weed',
        value: 'moderate',
      },
      {
        key: 'heavy',
  ...
  componentWillUnmount(){
    this.props.dryDockStore.offlineReportData.slides[5] = this.state.tableData;
...
TableSlide6.navigationOptions = {
  title: 'In Docking Fouling Condition Table',
};
